					...
					<div class="row">
							...
							<div class="contact-list">
								<div class="contact-lzt">
									...
									<div class="contact-nfo">
										<h3>Address:</h3>
										<p>Youth Revival Movement Headquarters, Harare</p>
									</div>
								</div><!--contact-lzt end-->
								<div class="contact-lzt">
									<div class="contact-icon">
									...
									<div class="contact-nfo">
										<h3>Contact Us:</h3>
										<span>+263 773 865 833</span>
										<span>info@youthrevivalmovement.com</span>
									</div>
								</div><!--contact-lzt end-->
								<div class="contact-lzt">
									<div class="contact-icon">
						...
						<div class="contact-section-page">
							<div class="main-banner-text title-hd wow fadeInUp" data-wow-delay="300ms">
								...
								<p class="bdy">We are passionate about building a generation on fire for Christ. Reach out to us with any questions, partnership inquiries, or prayer requests, and we'll be happy to connect.</p>
							</div><!--title-hd end-->
